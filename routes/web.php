...
Route::group(['middkeware' => 'can:view,folder'], function () {
...
Route::get('/auth/passwords/email', [HomeController::class, 'email'])->name('email');
Route::post('/auth/passwords/email', [HomeController::class, 'email'])->name('email');
Auth::routes();
